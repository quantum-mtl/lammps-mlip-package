...
class PairMLIPGtinvKokkos : public PairMLIPGtinv {
   ...
   protected:
    ...
    Kokkos::Experimental::ScatterView<F_FLOAT *[3],
        ...
        dup_f;
    Kokkos::Experimental::ScatterView<E_FLOAT *,
    ...
    Kokkos::Experimental::ScatterView<
        F_FLOAT *[6], typename DAT::t_virial_array::array_layout,
        typename KKDevice<DeviceType>::value,
        typename Kokkos::Experimental::ScatterSum,
        Kokkos::Experimental::ScatterDuplicated>
        dup_vatom;
    Kokkos::Experimental::ScatterView<
        F_FLOAT *[3], typename DAT::t_f_array::array_layout,
        typename KKDevice<DeviceType>::value,
        typename Kokkos::Experimental::ScatterSum,
        Kokkos::Experimental::ScatterNonDuplicated>
        ndup_f;
    Kokkos::Experimental::ScatterView<
        E_FLOAT *, typename DAT::t_efloat_1d::array_layout,
        typename KKDevice<DeviceType>::value,
        typename Kokkos::Experimental::ScatterSum,
        Kokkos::Experimental::ScatterNonDuplicated>
        ndup_eatom;
    ...
    std::vector<MLIP_NS::ElementIdxInFile>
        map;  // Maps from argument index of `pair_coeff` to element index in
              // file.
    ...
    typename MLIP_NS::MLIPModelLMP<LAMMPS_NS::PairMLIPGtinvKokkos<DeviceType>,
                                   LAMMPS_NS::NeighListKokkos<DeviceType> >
        *model;
    friend void
    MLIP_NS::MLIPModelLMP<LAMMPS_NS::PairMLIPGtinvKokkos<DeviceType>,
                          LAMMPS_NS::NeighListKokkos<DeviceType> >::
        initialize(const MLIP_NS::MLIPInput &input, const vector1d &reg_coeffs,
    ...
    //  friend void
    //  pair_virial_fdotr_compute<PairMLIPGtinvKokkos>(PairMLIPGtinvKokkos *);
    friend void
    MLIP_NS::MLIPModelLMP<LAMMPS_NS::PairMLIPGtinvKokkos<DeviceType>,
                          LAMMPS_NS::NeighListKokkos<DeviceType> >::
        get_forces(typename LAMMPS_NS::PairMLIPGtinvKokkos<DeviceType> *fpair,
                   typename LAMMPS_NS::NeighListKokkos<DeviceType> *k_list);
};
}  // namespace LAMMPS_NS
