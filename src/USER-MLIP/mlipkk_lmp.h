...
class MLIPModelLMP : public MLIPModel {
   public:
    ...
    void initialize(const MLIPInput &input, const vector1d &reg_coeffs,
                    const Readgtinv &gtinvdata, PairStyle *fpair);
    void compute(NeighListKokkos *k_list);

    void compute_order_parameters(NeighListKokkos *k_list);
    void compute_order_parameters(NeighFull neighflag, NewtonOff newton_pair,
                                  NeighListKokkos *k_list);
    void compute_order_parameters(NeighFull neighflag, NewtonOn newton_pair,
                                  NeighListKokkos *k_list);
    void compute_order_parameters(NeighHalfThread neighflag,
                                  NewtonOn newton_pair,
                                  NeighListKokkos *k_list);
    void compute_order_parameters(NeighHalf neighflag, NewtonOn newton_pair,
                                  NeighListKokkos *k_list);

    void compute_structural_features(NeighListKokkos *k_list);
    void compute_structural_features(NeighFull neighflag, NewtonOff newton_pair,
                                     NeighListKokkos *k_list);
    void compute_structural_features(NeighFull neighflag, NewtonOn newton_pair,
                                     NeighListKokkos *k_list);
    void compute_structural_features(NeighHalfThread neighflag,
                                     NewtonOn newton_pair,
                                     NeighListKokkos *k_list);
    void compute_structural_features(NeighHalf neighflag, NewtonOn newton_pair,
                                     NeighListKokkos *k_list);

    void compute_energy(NeighListKokkos *k_list);
    void compute_energy(NeighFull neighflag, NewtonOff newton_pair,
                        NeighListKokkos *k_list);
    void compute_energy(NeighFull neighflag, NewtonOn newton_pair,
                        NeighListKokkos *k_list);
    void compute_energy(NeighHalfThread neighflag, NewtonOn newton_pair,
                        NeighListKokkos *k_list);
    void compute_energy(NeighHalf neighflag, NewtonOn newton_pair,
                        NeighListKokkos *k_list);

    void compute_polynomial_adjoints(NeighListKokkos *k_list);
    void compute_polynomial_adjoints(NeighFull neighflag, NewtonOff newton_pair,
                                     NeighListKokkos *k_list);
    void compute_polynomial_adjoints(NeighFull neighflag, NewtonOn newton_pair,
                                     NeighListKokkos *k_list);
    void compute_polynomial_adjoints(NeighHalfThread neighflag,
                                     NewtonOn newton_pair,
                                     NeighListKokkos *k_list);
    void compute_polynomial_adjoints(NeighHalf neighflag, NewtonOn newton_pair,
                                     NeighListKokkos *k_list);

    void compute_basis_function_adjoints(NeighListKokkos *k_list);
    void compute_basis_function_adjoints(NeighFull neighflag,
                                         NewtonOff newton_pair,
                                         NeighListKokkos *k_list);
    void compute_basis_function_adjoints(NeighFull neighflag,
                                         NewtonOn newton_pair,
                                         NeighListKokkos *k_list);
    void compute_basis_function_adjoints(NeighHalfThread neighflag,
                                         NewtonOn newton_pair,
                                         NeighListKokkos *k_list);
    void compute_basis_function_adjoints(NeighHalf neighflag,
                                         NewtonOn newton_pair,
                                         NeighListKokkos *k_list);

    void compute_forces_and_stress(NeighListKokkos *k_list);
    void compute_forces_and_stress(NeighFull neighflag, NewtonOff newton_pair,
                                   NeighListKokkos *k_list);
    void compute_forces_and_stress(NeighFull neighflag, NewtonOn newton_pair,
                                   NeighListKokkos *k_list);
    void compute_forces_and_stress(NeighHalfThread neighflag,
                                   NewtonOn newton_pair,
                                   NeighListKokkos *k_list);
    void compute_forces_and_stress(NeighHalf neighflag, NewtonOn newton_pair,
                                   NeighListKokkos *k_list);
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::initialize(
    const MLIPInput &input, const vector1d &reg_coeffs,
    const Readgtinv &gtinvdata, PairStyle *fpair) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute(
    NeighListKokkos *k_list) {
#ifdef _DEBUG
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_order_parameters(
    NeighListKokkos *k_list) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_structural_features(
    NeighListKokkos *k_list) {
    if (neighflag_ == FULL && newton_pair_ == 0) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_energy(
    NeighListKokkos *k_list) {
    if (neighflag_ == FULL && newton_pair_ == 0) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_polynomial_adjoints(
    NeighListKokkos *k_list) {
    if (neighflag_ == FULL && newton_pair_ == 0) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_basis_function_adjoints(
    NeighListKokkos *k_list) {
    if (neighflag_ == FULL && newton_pair_ == 0) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_forces_and_stress(
    NeighListKokkos *k_list) {
    if (neighflag_ == FULL && newton_pair_ == 0) {
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_order_parameters(
    NeighFull neighflag, NewtonOn newton_pair, NeighListKokkos *k_list) {
    Kokkos::parallel_for(
        "init_anlm_full",
        Kokkos::MDRangePolicy<ExecSpace, Kokkos::Rank<4>>(
            {0, 0, 0, 0}, {nlocal_, n_types_, n_fn_, n_lm_half_}),
        KOKKOS_CLASS_LAMBDA(const LMPLocalIdx i, const ElementType type,
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_CLASS_LAMBDA(const NeighborPairIdx npidx, const int n,
            ...
            //    s_anlm_i_a(j, type_i, n, lmi) -= val.imag() * scale;  // take
            //    c.c
            //  }
        });
...
template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_order_parameters(
    NeighFull neighflag, NewtonOff newton_pair, NeighListKokkos *k_list) {
    ;  // do nothing
}

template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_order_parameters(
    NeighHalfThread neighflag, NewtonOn newton_pair, NeighListKokkos *k_list) {
    MLIPModel::compute_order_parameters();
}

template <class PairStyle, class NeighListKokkos>
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_order_parameters(
    NeighHalf neighflag, NewtonOn newton_pair, NeighListKokkos *k_list) {
    MLIPModel::compute_order_parameters();
}
...
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_energy(
    ...
    // initialize
    Kokkos::parallel_for(
        "init_energy", range_policy(0, nlocal_),
        KOKKOS_LAMBDA(const LMPLocalIdx i) { d_site_energy(i) = 0.0; });
...
void MLIPModelLMP<PairStyle, NeighListKokkos>::compute_basis_function_adjoints(
    ...
    Kokkos::parallel_for(
        ...
        Kokkos::MDRangePolicy<ExecSpace, Kokkos::Rank<4>>(
            {0, 0, 0, 0}, {nlocal_, n_typecomb_, n_fn_, n_lm_half_}),
        KOKKOS_CLASS_LAMBDA(const LMPLocalIdx i, const TypeCombIdx tcidx,
                            const int n, const LMInfoIdx lmi) {
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_CLASS_LAMBDA(const SiteIdx ii, const IrrepsTypeCombIdx itcidx,
                            const int n) {
            const LMPLocalIdx i = d_ilist(ii);
            const ElementType type_i = d_types(i);
            if (!d_irreps_type_intersection(itcidx, type_i)) {
            ...
            if (j < nlocal_ && j < i) {
                for (int n = 0; n < n_fn_; ++n) {
                    for (LMInfoIdx lmi = 0; lmi < n_lm_half_; ++lmi) {
                        ...
                        const auto f1 =
                            d_fn_der_(npidx, n) * d_ylm_(npidx, lmi);
                        ...
                        fx += coeff *
                              product_real_part(
                                  d_basis_function_adjoints_(i, tc_ij, n, lmi),
                                  basis_function_dx);
                        fy += coeff *
                              product_real_part(
                                  d_basis_function_adjoints_(i, tc_ij, n, lmi),
