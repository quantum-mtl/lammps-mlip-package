...
/// Ref. Associated Legendre Polynomials and Spherical Harmonics Computation for Chemistry Applications (2014). Taweetham Limpanuparb and Josh Milthorpe. arXiv: 1410.1748 [physics.chem-ph]
...
public:
    ...
    void compute_ylm(const double costheta, const double azimuthal, vector1dc& ylm) const;
    void compute_ylm_der(const double costheta, const double azimuthal, const double r,
                         vector1dc& ylm_dx, vector1dc& ylm_dy, vector1dc& ylm_dz) const;
...
private:
    ...
    void compute_normalized_associated_legendre(const double costheta, vector1d& p) const;
