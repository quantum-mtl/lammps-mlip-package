...
private:
    void enumerate_polynomials_model_type_1(const std::vector<IrrepsTypePair>& irreps_type_pairs);
    void enumerate_polynomials_model_type_2(const std::vector<IrrepsTypePair>& irreps_type_pairs);
    void enumerate_polynomials_model_type_3(const std::vector<IrrepsTypePair>& irreps_type_pairs);
    void enumerate_polynomials_model_type_4(const std::vector<IrrepsTypePair>& irreps_type_pairs);
    void enumerate_polynomials_model_type_3_or_4(const std::vector<IrrepsTypePair>& irreps_type_pairsm, const std::vector<FeatureIdx>& lower_feature_indices);

    std::vector<bool> get_typecombs_intersection(const std::vector<FeatureIdx>& fcomb,
                                                 const std::vector<IrrepsTypePair>& irreps_type_pairs);
};
