...
Polynomial::Polynomial(const struct feature_params& fp,
                       const ModelParams& modelp, const vector2i& lm_info) {
    if (fp.n_type == 1)
        swap_rule = {{0}};
    else if (fp.n_type == 2)
        swap_rule = {{0, 1, 2}, {2, 1, 0}, {0, 1, 2}};
...
void Polynomial::set_swap_map_gtinv(const struct feature_params fp,
...
vector1i Polynomial::tc_array_swap(const int& tc0, const vector1i& tc_array,
...
int Polynomial::find_comb(const std::set<vector1i>& uniq_comb_set,
...
int Polynomial::tcn2seq(const int& tc, const int& n) { return tc * n_fn + n; }
...
const vector2i& Polynomial::get_swap_map_poly() const { return swap_map_poly; }
const vector2i& Polynomial::get_swap_map_lmtc() const { return swap_map_lmtc; }
const vector2i& Polynomial::get_swap_map_gtinv() const {
    return swap_map_gtinv;
}
const vector2i& Polynomial::get_lmtc_map() const { return lmtc_map; }
const vector2i& Polynomial::get_comb2() const { return comb2; }
const vector2i& Polynomial::get_comb3() const { return comb3; }
