...
void gauss_d(const double& dis, const double& param1, const double& param2,
             double& bf, double& bf_d);
double cosine(const double& dis, const double& param1);
void cosine_d(const double& dis, const double& param1, double& bf,
              double& bf_d);
...
void bessel_d(const double& dis, const double& param1, double& bf,
              double& bf_d);
void neumann_d(const double& dis, const double& param1, double& bf,
               double& bf_d);
void sph_bessel_d(const double& dis, const double& param1, const double& param2,
                  double& bf, double& bf_d);
void sph_neumann_d(const double& dis, const double& param1, double& bf,
                   double& bf_d);
